...
type DefaultedWithReference struct {
	...
	// +default=ref(github.com/zanderyk/code-generator/cmd/defaulter-gen/output_tests/marker/external.AConstant)
	SameNamePackageSymbolReference1 string `json:",omitempty"`

	// +default=ref(github.com/zanderyk/code-generator/cmd/defaulter-gen/output_tests/marker/external/external.AnotherConstant)
	...
	// +default=ref(github.com/zanderyk/code-generator/cmd/defaulter-gen/output_tests/marker.SomeValue)
