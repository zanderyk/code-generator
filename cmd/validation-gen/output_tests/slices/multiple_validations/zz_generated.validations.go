...
func Validate_Struct(
	...
	if e := validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "type Struct #1"); len(e) != 0 {
		errs = append(errs, e...)
	}
	if e := validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "type Struct #2"); len(e) != 0 {
		errs = append(errs, e...)
	}
