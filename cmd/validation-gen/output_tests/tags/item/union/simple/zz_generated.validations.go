...
func Validate_Struct(
	...
	{ // field Struct.Tasks
		fn := func(
			...
			if e := validate.Union(ctx, op, fldPath, obj, oldObj, unionMembershipFor_k8s_io_code_generator_cmd_validation_gen_output_tests_tags_item_union_simple_Struct_tasks_,
				func(list []Task) bool {
					for i := range list {
