...
func Validate_ConditionalStruct(
	...
	{ // field ConditionalStruct.ConditionalEnumField
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ConditionalStruct) *ConditionalEnum {
				return &oldObj.ConditionalEnumField
			})
	...
	{ // field ConditionalStruct.ConditionalEnumPtrField
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ConditionalStruct) *ConditionalEnum {
				return oldObj.ConditionalEnumPtrField
			})
		errs = append(errs, fn(fldPath.Child("conditionalEnumPtrField"), obj.ConditionalEnumPtrField, oldVal, oldObj != nil)...)
	}
...
func Validate_Struct(
	...
	{ // field Struct.EnumWithExcludeField
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *Struct) *EnumWithExclude {
				return &oldObj.EnumWithExcludeField
			})
	...
	{ // field Struct.EnumWithExcludePtrField
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *Struct) *EnumWithExclude {
				return oldObj.EnumWithExcludePtrField
			})
		errs = append(errs, fn(fldPath.Child("enumWithExcludePtrField"), obj.EnumWithExcludePtrField, oldVal, oldObj != nil)...)
	}
