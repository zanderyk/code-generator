...
import (
	...
	v1 "github.com/zanderyk/code-generator/examples/apiserver/apis/example2/v1"
	example2v1 "github.com/zanderyk/code-generator/examples/apiserver/clientset/versioned/typed/example2/v1"
)
