...
import (
	...
	v1 "github.com/zanderyk/code-generator/examples/apiserver/apis/example3.io/v1"
	example3iov1 "github.com/zanderyk/code-generator/examples/apiserver/clientset/versioned/typed/example3.io/v1"
)
